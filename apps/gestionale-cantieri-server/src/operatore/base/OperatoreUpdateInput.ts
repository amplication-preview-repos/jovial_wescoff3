...
class OperatoreUpdateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => LavorazioniUpdateManyWithoutOperatoresInput,
  })
  @ValidateNested()
  @Type(() => LavorazioniUpdateManyWithoutOperatoresInput)
  @IsOptional()
  @Field(() => LavorazioniUpdateManyWithoutOperatoresInput, {
    nullable: true,
  })
...
export { OperatoreUpdateInput as OperatoreUpdateInput };
